...
export default function LandingPage() {
  return (
    <div className="flex flex-col items-center justify-center  max-w-screen-xl px-8">
      ...
      <div className="text-sm md:text-lg text-center max-w-xs md:max-w-2xl mx-auto">
        <p>
          ...
          planning, authentication, and attendance tracking. It offers a secure
          and flexible solution for educational institutions, simplifying
